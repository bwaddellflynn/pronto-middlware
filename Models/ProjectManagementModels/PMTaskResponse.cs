...
namespace Pronto.Middleware.Models.ProjectManagementModels
{
    public class PMTaskResponse
    {
        ...
        [JsonProperty("milestone")] public string? MilestoneId { get; set; }
        ...
        // New JSON mappings for billing and budgeting
        [JsonProperty("billable")] public string? Billable { get; set; }
        [JsonProperty("nonbillable")] public string? NonBillable { get; set; }
